...
class DOTA2LongSideFormatYOLODataset(Dataset):
    ...
    def __init__(self, num_classes, cat_names2id, anchors, anchors_mask, ann_dir, img_dir, img_shape=[1024, 1024], input_shape=[800, 800], trainMode=True):
...
def test_yolo():
    ...
    ''' 自定义数据集读取类'''
    trainDataset = DOTA2LongSideFormatYOLODataset(cls_num, cat_names2id, anchors, anchors_mask, train_ann_dir, train_img_dir, imgSize, input_shape, trainMode=True)
