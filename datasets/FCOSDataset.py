...
class COCODataset(BaseDataset):
    ...
    def __init__(self, num_classes, annPath, imgDir, inputShape=[800, 800], trainMode=True, map=None):
        '''__init__() 为默认构造函数，传入数据集类别（训练或测试），以及数据集路径
...
def test_coco():
    ...
    '''COCO'''
    trainAnnPath = "F:/Desktop/研究生/datasets/Universal/COCO2017/COCO/annotations/instances_train2017.json"
    valAnnPath = "F:/Desktop/研究生/datasets/Universal/COCO2017/COCO/annotations/instances_val2017.json"
    trainImgDir =  "F:/Desktop/研究生/datasets/Universal/COCO2017/COCO/train2017"
    valImgDir = "F:/Desktop/研究生/datasets/Universal/COCO2017/COCO/val2017"
    cls_num = 80
